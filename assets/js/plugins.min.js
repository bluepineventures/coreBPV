 ...
 */
function(){var t,e;t=this.jQuery||window.jQuery,e=t(window),t.fn.stick_in_parent=function(i){var n,o,a,r,s,l,c,u,d,p,m,h;for(null==i&&(i={}),h=i.sticky_class,l=i.inner_scrolling,m=i.recalc_every,p=i.parent,d=i.offset_top,u=i.spacer,a=i.bottoming,null==d&&(d=0),null==p&&(p=void 0),null==l&&(l=!0),null==h&&(h="is_stuck"),n=t(document),null==a&&(a=!0),r=function(i,o,r,s,c,f,v,g){var y,b,w,x,_,I,C,T,k,S,E,A;if(!i.data("sticky_kit")){if(i.data("sticky_kit",!0),_=n.height(),C=i.parent(),null!=p&&(C=C.closest(p)),!C.length)throw"failed to find stick parent";if(w=!1,y=!1,E=null!=u?u&&i.closest(u):t("<div />"),E&&E.css("position",i.css("position")),T=function(){var t,e,a;if(!g)return _=n.height(),t=parseInt(C.css("border-top-width"),10),e=parseInt(C.css("padding-top"),10),o=parseInt(C.css("padding-bottom"),10),r=C.offset().top+t+e,s=C.height(),w&&(w=!1,y=!1,null==u&&(i.insertAfter(E),E.detach()),i.css({position:"",top:"",width:"",bottom:""}).removeClass(h),a=!0),c=i.offset().top-(parseInt(i.css("margin-top"),10)||0)-d,f=i.outerHeight(!0),v=i.css("float"),E&&E.css({width:i.outerWidth(!0),height:f,display:i.css("display"),"vertical-align":i.css("vertical-align"),"float":v}),a?A():void 0},T(),f!==s)return x=void 0,I=d,S=m,A=function(){var t,p,b,k,A,P;if(!g)return b=!1,null!=S&&(S-=1,S<=0&&(S=m,T(),b=!0)),b||n.height()===_||(T(),b=!0),k=e.scrollTop(),null!=x&&(p=k-x),x=k,w?(a&&(A=k+f+I>s+r,y&&!A&&(y=!1,i.css({position:"fixed",bottom:"",top:I}).trigger("sticky_kit:unbottom"))),k<c&&(w=!1,I=d,null==u&&("left"!==v&&"right"!==v||i.insertAfter(E),E.detach()),t={position:"",width:"",top:""},i.css(t).removeClass(h).trigger("sticky_kit:unstick")),l&&(P=e.height(),f+d>P&&(y||(I-=p,I=Math.max(P-f,I),I=Math.min(d,I),w&&i.css({top:I+"px"}))))):k>c&&(w=!0,t={position:"fixed",top:I},t.width="border-box"===i.css("box-sizing")?i.outerWidth()+"px":i.width()+"px",i.css(t).addClass(h),null==u&&(i.after(E),"left"!==v&&"right"!==v||E.append(i)),i.trigger("sticky_kit:stick")),w&&a&&(null==A&&(A=k+f+I>s+r),!y&&A)?(y=!0,"static"===C.css("position")&&C.css({position:"relative"}),i.css({position:"absolute",bottom:o,top:"auto"}).trigger("sticky_kit:bottom")):void 0},k=function(){return T(),A()},b=function(){if(g=!0,e.off("touchmove",A),e.off("scroll",A),e.off("resize",k),t(document.body).off("sticky_kit:recalc",k),i.off("sticky_kit:detach",b),i.removeData("sticky_kit"),i.css({position:"",bottom:"",top:"",width:""}),C.position("position",""),w)return null==u&&("left"!==v&&"right"!==v||i.insertAfter(E),E.remove()),i.removeClass(h)},e.on("touchmove",A),e.on("scroll",A),e.on("resize",k),t(document.body).on("sticky_kit:recalc",k),i.on("sticky_kit:detach",b),setTimeout(A,0)}},s=0,c=this.length;s<c;s++)o=this[s],r(t(o));return this}}.call(this),/*
